...
/**
 * Implement the function that finds the minimum total sum of squares of the slacks of all lines
and returns a pretty-printed version of the input string.

The first line contains the line Length L
, the second line contains the amount of words n


and the next line contains the input string.
